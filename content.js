function injectDownloadButton() {
    ...
    if (detailsContainer && avatarSpan && !document.getElementById('osu-avatar-dl-btn')) {
        ...
        dlBtn.innerHTML = `
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" style="width: 14px; height: 14px; fill: white;">
                <path d="M288 32c0-17.7-14.3-32-32-32s-32 14.3-32 32V274.7L154.7 205.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l128 128c12.5 12.5 32.8 12.5 45.3 0l128-128c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L288 274.7V32zM71.1 432c0-13.2-10.8-24-24-24s-24 10.8-24 24v48c0 17.7 14.3 32 32 32H456.9c17.7 0 32-14.3 32-32V432c0-13.2-10.8-24-24-24s-24 10.8-24 24v32H71.1V432z"/>
            </svg>
        `;
        ...
        dlBtn.onmouseenter = () => dlBtn.style.backgroundColor = "rgba(0, 0, 0, 0.5)";
        dlBtn.onmouseleave = () => dlBtn.style.backgroundColor = "rgba(0, 0, 0, 0.3)";
        ...
        dlBtn.onclick = (e) => {
            ...
            if (imageUrl) {
                console.log("Downloade Avatar für User:", currentUsername);
